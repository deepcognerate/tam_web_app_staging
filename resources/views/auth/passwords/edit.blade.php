        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route("profile.password.updateProfile") }}">
                    ...
                    <?php if(!empty($feature) AND !empty($multiFeature)) {
                        echo '<label class="required" for="title">Feature :- </label>';
                        foreach ($feature as $key => $value) {
                           if(in_array($value->id, $multiFeature)){
                            echo '<span class="badge badge-info">'.$value->feature_name.'</span> ';
                           }
                        }
                    ...
                    <?php if(!empty($categorys) AND !empty($multiCategory)) {
                        echo '<label class="required" for="title">Categorys :- </label>';
                        foreach ($categorys as $key => $value) {
                           if(in_array($value->id, $multiCategory)){
                             echo '<span class="badge badge-info">'.$value->category_name.'</span> ';
                           }
                        }
