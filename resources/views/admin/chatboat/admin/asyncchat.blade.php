            ...
            <div class="chat-box-body">
              <div class="chat-logs chat-history" >
                ...
                @foreach($asyncChats as $asyncChat)
                 <?php 
                  if(!in_array( $asyncChat->date ,$dates)){
                    $dates[] = $asyncChat->date;
                ...
                width: 100%;">'.$asyncChat->date.'</label> <div id="cm-msg-2" class="chat-msg user" >  </div><div id="cm-msg-1" class="chat-msg self" ></div>';
                  }                  
                 ?>
                ...
                <div id="cm-msg-2" class="chat-msg user" >          
                    ...
                    <div class="cm-msg-text"><span> {{ $asyncChat->message }}</span></br><small>{{ $asyncChat->date }} {{ $asyncChat->time }}</small></div>        
                </div>
                @else 
                  ...
                  <div id="cm-msg-1" class="chat-msg self" >
                      ...
                      <div class="cm-msg-text"><span><embed src="{{asset('public/chatAttachment/')}}/<?php echo $asyncChat->chatAttachment; ?>" width= "300" height= "300"></span></br><small style="float:right;">{{ $asyncChat->date }} {{ $asyncChat->time }}</small></div>        
                  </div>
                 @endif
                  ...
                  @if($asyncChat->message != 'attachment')
                    <div id="cm-msg-1" class="chat-msg self" >
                      ...
                      <div class="cm-msg-text"><span>{{ $asyncChat->message }}</span></br><small style="float:right;">{{ $asyncChat->date }} {{ $asyncChat->time }}</small></div>        
                  </div>
                    @endif
