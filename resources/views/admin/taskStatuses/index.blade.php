...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table   table-striped   datatable datatable-TaskStatus">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <tr data-entry-id="{{ $taskStatus->id }}">
                            ...
                            <td>
                                @can('task_status_show')
                                    <a class=" btn btn-gradient-primary btn-rounded btn-icon" href="{{ route('admin.task-statuses.show', $taskStatus->id) }}">
                                       <i class="fa fa-eye" aria-hidden="true"></i>
                                    </a>
                                @endcan

                                @can('task_status_edit')
                                    <a class="btn btn-gradient-primary btn-rounded btn-icon" href="{{ route('admin.task-statuses.edit', $taskStatus->id) }}">
